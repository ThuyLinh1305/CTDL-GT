...
int main()
{
	...
	bool inp = false;
	do {
		cout << "------------Baitap 1, chuong 2, danh sach dac---------\n";
		cout << "1.Nhap danh sach" << endl << "2.Xuat danh sach" << endl << "3.Tim mot phan tu trong danh sach" << endl << "4.Them mot phan tu vao cuoi danh sach" << endl << "5.Xoa phan tu o cuoi danh sach" << endl << "6.Xoa phan tu tai vi tri i" << endl << "7.Tim mot phan tu trong danh sach va xoa" << endl << "8.Thoat" << endl;
		cout << " Chon tinh nang:";
		cin >> choice;
		switch (choice)
		{

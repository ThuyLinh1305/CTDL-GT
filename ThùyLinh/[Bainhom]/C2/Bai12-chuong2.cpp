...
int main1() {
    ...
    cout << "2.Them phan tu o dau danh sach " << endl;
    ...
    cout << "7.Tim phan tu gia tri x trong DSLK doi" << endl;
    ...
    do {
        ...
        case 1:
            init();
            cout << " Khoi tao thanh cong danh sach !!!";
            break;
        case 2:
            cout << "Nhap vao phan tu x=";
            cin >> x;
            Insert_first(x);
            cout << "Danh sach sau khi them phan tu x vao dau x=" << x << endl;
            Process_list();
            break;
        case 3:
            cout << "Nhap vao phan tu x=";
            cin >> x;
            Insert_last(x);
            cout << "Danh sach sau khi them phan tu x vao cuoi x=" << x << endl;
            Process_list();
            break;
        case 4:
            i = Delete_first();
            if (i == 0) {
                ...
                cout << "Xoa thanh cong phan tu dau ds! DS sau khi xoa la : " << endl;
                Process_list();
            }
            break;
        case 5:
            ...
            if (i == 0) {
                ...
                cout << "Xoa thanh cong phan tu cuoi  ds! DS sau khi xoa la : " << endl;
                Process_list();
            }
            break;
        case 6:
            ...
            break;
        case 7:
            cout << "Vui long nhap phan tu can tim x= ";
            cin >> x;
            p = search(x);
            if (p == NULL)
